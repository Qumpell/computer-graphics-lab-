...
namespace Core
{
	...
	struct ColorPhongMaterial : Core::Material {
		glm::vec3 color;
		void init_data();
	...
	// vertexArray - jednowymiarowa tablica zawierajaca wartosci opisujace pozycje kolejnych wierzcholkow w jednym ciagu (x1, y1, z1, w1, x2, y2, z2, w2, ...)x 
